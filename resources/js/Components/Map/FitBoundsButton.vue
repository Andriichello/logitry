    ...
    <svg width="48" height="48" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
      <g id="Iconly/Light-Outline/Discovery">
        <g id="Discovery">
          ...
          <g id="Group 5">
            <mask id="mask0_33437_4965" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="2" y="2"
                  width="21" height="21">
              <path id="Clip 4" fill-rule="evenodd" clip-rule="evenodd" d="M2 2H22.7218V22.7217H2V2Z" />
            </mask>
            <g mask="url(#mask0_33437_4965)">
