...
<template>
  <div class="p-2">
    ...
    <div class="w-full flex flex-col justify-start items-center p-3"
      v-if="mapStore.route">
      ...
      <div class="w-full flex flex-row justify-between items-baseline gap-2 p-2">
      ...
      <div class="w-full max-h-[60vh] flex flex-col justify-start items-start gap-1"
        ...
        <div class="w-full flex flex-row justify-between items-end gap-2 p-2">
        ...
        <template v-for="(point, index) in mapStore.route?.points" :key="point.id">
          <div class="w-full flex flex-col justify-end items-center" v-if="!arePointsHidden">
